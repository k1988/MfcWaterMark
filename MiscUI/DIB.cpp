...
void CDib::Create32BitFromPicture (CBitmap& bitmap, int iWidth, int iHeight)
{
    CRect r;
    CBitmap newBMP;
    CWindowDC dc(NULL);
	...
	//bitmap.CreateDiscardableBitmap(&dc,iWidth,iHeight);
	//newBMP.LoadBitmapW();
   ...
   // pPicture->Render(&tempDC,r,r);
    ...
    for(int i=0;i<iHeight;i++)
    {
        ...
        {
            pAr[(i*iWidth)+j] = FixColorRef(tempDC.GetPixel(j, iHeight - i));
        }
    }
